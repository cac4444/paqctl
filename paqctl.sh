...
# ║                                                                   ║
# ║  Paqet: https://github.com/cac4444/paqctl                       ║
# ╚═══════════════════════════════════════════════════════════════════╝
#
# Usage:
# curl -sL https://raw.githubusercontent.com/cac4444/paqctl/main/paqctl.sh | sudo bash
#
...
# https://github.com/cac4444/paqctl
#
...
update_management_script() {
    local update_url="https://raw.githubusercontent.com/cac4444/paqctl/main/paqctl.sh"
    local tmp_script
...
show_help() {
    ...
    echo ""
    echo -e "${BOLD}Paqet:${NC} https://github.com/cac4444/paqctl"
    echo ""
}
...
show_version() {
    ...
    echo ""
    echo -e "  ${DIM}paqctl by cac4444: https://github.com/cac4444/paqctl${NC}"
    echo ""
}
    ...
    while true; do
        ...
        case "$i_choice" in
            1)
                ...
                echo -e "  ${DIM}Project: https://github.com/cac4444/paqctl${NC}"
                echo ""
                read -n 1 -s -r -p "  Press any key..." < /dev/tty || true
                redraw=true
                ;;
            ...
            5)
                ...
                echo -e "  ${BOLD}Repository:${NC} https://github.com/cac4444/paqctl"
                ...
                echo ""
                echo -e "  ${BOLD}Built by:${NC}   cac4444"
                echo -e "  ${BOLD}Repository:${NC} https://github.com/cac4444/paqctl"
                echo -e "  ${BOLD}License:${NC}    AGPL-3.0 - Copyright (C) 2026 SamNet Technologies, LLC"
                echo ""
